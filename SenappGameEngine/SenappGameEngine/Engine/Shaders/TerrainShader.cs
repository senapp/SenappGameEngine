...
namespace Senapp.Engine.Shaders
{
    ...
    {
        private static readonly string VERTEX_SHADER_FILE = "Resources/Shaders/terrainVertexShader.glsl";
        private static readonly string FRAGMENT_SHADER_FILE = "Resources/Shaders/terrainFragmentShader.glsl";
