...
namespace Senapp.Engine.Shaders
{
    ...
    {
        private static readonly string VERTEX_SHADER_FILE = "Resources/Shaders/skyboxVertexShader.glsl";
        private static readonly string FRAGMENT_SHADER_FILE = "Resources/Shaders/skyboxFragmentShader.glsl";
